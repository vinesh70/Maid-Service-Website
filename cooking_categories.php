...
<head>
  ...
  <style>
    body {
      background-image: url('cook2.jpeg'); /* Add your background image path */
...
<div class="navbar">
  ...
  <div class="transparent-box">
    <h3>Types of our Cooking Services</h3>
    <hr>
    <!-- Clickable Categories -->
    <a href="#" class="category">Non-Veg</a>
    <hr>
    <a href="#" class="category">Veg</a>
    <hr>
    <a href="#" class="category">Breakfast</a>
    <hr>
    <a href="#" class="category">Lunch</a>
    <hr>
    <a href="#" class="category">Dinner</a>
    <hr>
    <a href="cooking.php" class="btn btn-primary" >Find a chef</a>
  </div>
